...
Config = {
    ...
    Text = {
        ...
        SPRAY_ERRORS = {
            NOT_FLAT = 'The surface is not flat enough',
            TOO_FAR = 'The surface is too far away',
            INVALID_SURFACE = 'You cannot use the spray on this surface',
            AIM = 'Point the spray at a flat wall',
        },
        NO_SPRAY_NEARBY = 'There are no sprays to remove',
        NEED_SPRAY = 'You dont have a spray can',
        WORD_LONG = 'The word can be up to 9 characters long',
        USAGE = 'Usage: /spray <word>',
        BLACKLISTED = 'The word is blacklisted'
    }
}
